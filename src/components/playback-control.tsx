    ...
    >
      ...
      <div className="w-full max-w-[calc(100%-200px)]">
        <input
          disabled={status === 'stopped'}
          type="range"
          className="w-full disabled:opacity-30 accent-indigo-500 appearance-none bg-transparent [&::-webkit-slider-runnable-track]:rounded-lg [&::-webkit-slider-runnable-track]:bg-indigo-500/40"
          min="0"
          max={endTimestamp || 1}
